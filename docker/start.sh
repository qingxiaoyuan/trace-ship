...
echo ""
echo "🦊 GitLab (Git 仓库):    http://localhost:${GITLAB_HTTP_PORT:-18929}"
echo "   管理员账号: root / ${GITLAB_ROOT_PASSWORD:-GitlabAdmin@2024}"
echo "   注意: GitLab 首次启动需等待数分钟，可执行 docker logs ${COMPOSE_PROJECT_NAME:-release-manager-dev}-gitlab -f 观察"
echo ""
