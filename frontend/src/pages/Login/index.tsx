  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 12px 24px -6px rgba(15, 23, 42, 0.08), 0 6px 12px -4px rgba(15, 23, 42, 0.05)",
      }}
    >
      {/* 品牌区 */}
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="text-2xl font-bold text-slate-900">溯舟</div>
      ...
      >
        ...
        >
          <Input
            placeholder={
              activeTab === "domain" ? "请输入域账号/用户名" : "请输入本地账号"
            }
            style={{
              height: 40,
              borderRadius: 12,
        ...
        <div className="flex items-center justify-between text-sm mb-6">
          ...
          <Link className="text-sm font-medium" style={{ color: "#2563EB" }}>
            忘记密码？
          </Link>
        </div>
        ...
        <Button
          ...
          style={{
            ...
            boxShadow:
              "0 1px 2px rgba(37, 99, 235, 0.25), inset 0 1px 0 rgba(255, 255, 255, 0.15)",
          }}
        >
          登 录
        </Button>
