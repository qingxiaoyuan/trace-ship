...
export const changelogEntries: ChangelogEntry[] = [
  {
    version: '2026.08.28',
    date: '2026-08-28',
    summary: '打包节点支持芯片架构、麒麟节点脚本修正为 sh；项目成员授权分级收缩；审查列表新增待复核徽标；管理员可发送系统通知',
    items: [
      ...
      { category: 'feature', text: '项目成员授权分级收缩：项目负责人可授予全部角色；软件管理员不能授予项目负责人 / 软件管理员；开发、测试等其他角色也能拉人进项目，但只能授予开发 / 测试角色；移除成员与调整角色仍仅项目管理员可操作' },
  ...
  },
  {
    ...
    items: [
      ...
      { category: 'feature', text: '「导出周报」功能落地：一键导出近 7 天发布记录 CSV（版本/项目/仓库/类型/状态/发布人/时间）' },
      { category: 'improvement', text: '审批详情「发布摘要」新增「所属软件」字段，审批头部项目名加粗加深，一眼可辨是哪个软件要发布' },
      { category: 'fix', text: '修复打包配置详情页误显示「该配置暂无打包记录」：看板任务列表拆分进行中/历史后，配置最新任务查找仍只查进行中列表，已结束任务永远找不到，现改为按配置拉取完整记录后自动选中最新一条' },
      { category: 'fix', text: '修复审批流程时间线只显示第一个审批人的问题：会签/或签节点的全部审批人现在完整展示；未激活节点也会显示配置的审批人（项目负责人/角色/指定用户），不再一律显示「待分配审批人」' },
