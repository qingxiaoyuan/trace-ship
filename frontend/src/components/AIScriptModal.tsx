      ...
      <div className="space-y-4">
        ...
        {draft && (
          <>
            ...
            <div className="mt-3 flex h-[46vh] gap-3 max-md:flex-col">
              <div className="min-w-0 flex-1 overflow-hidden rounded-xl border border-slate-200 bg-[#fbfcfe] max-md:min-h-0">
              ...
              <div className="w-[340px] shrink-0 overflow-hidden rounded-xl border border-slate-200 bg-white max-md:min-h-0 max-md:w-full max-md:flex-1">
