...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-lg mr-3"
          style={{
        ...
        <div className="flex flex-col">
          <Title level={5} className="!m-0 !text-slate-900">TraceShip</Title>
          <Text className="text-[10px] text-slate-400 tracking-wider">RELEASE MGMT</Text>
        </div>
      </div>
