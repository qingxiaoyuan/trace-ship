        ...
        children: [
          ...
          { path: 'changelog', element: <PageLoader><Changelog /></PageLoader>, handle: { title: '更新日志' } },
          {
            ...
            children: [
              ...
              { path: 'access-tokens', element: <RequirePermission permission="system.access_token"><PageLoader><SystemAccessTokenList /></PageLoader></RequirePermission>, handle: { title: '访问令牌' } },
              ...
              { path: 'notifications', element: <RequirePermission permission="system.notification"><PageLoader><SystemNotificationSend /></PageLoader></RequirePermission>, handle: { title: '通知发送' } },
