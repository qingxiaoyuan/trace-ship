    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'packages', element: <PageLoader><PackageTask /></PageLoader>, handle: { title: '打包任务' } },
          { path: 'packages/:id', element: <PageLoader><PackageTask /></PageLoader>, handle: { title: '打包任务详情' } },
